    ...
    <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
      <div className="flex items-center mb-4">
        ...
        <div>
          ...
          <p className="text-2xl font-bold text-gray-900">{batchData.batch_id}</p>
        </div>
      </div>
    </div>
    ...
    <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
      <div className="flex items-center mb-4">
        ...
        <div>
          ...
          <p className="text-2xl font-bold text-gray-900">{batchData.production_data.binder}</p>
        </div>
      </div>
    </div>
    ...
    <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
      <div className="flex items-center mb-4">
        ...
        <div>
          ...
          <p className="text-2xl font-bold text-gray-900">{batchData.production_data.drying_temperature}°C</p>
        </div>
      </div>
    </div>
